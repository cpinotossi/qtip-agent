...
public class TestClientPublishToHelloAll extends MyTestParameters {
	...
	public void test() {
		...
		try {
			...
			client.connect();
			String msg = this.getClientHelloAllMessage();
			client.publish(this.getTopicHelloAll(), msg.getBytes(), 2, false);
			client.disconnect();
	        System.exit(0);
